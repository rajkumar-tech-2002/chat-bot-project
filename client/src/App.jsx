...
function AppContent({ authenticated, setAuthenticated }) {
  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-slate-100 flex flex-col font-sans relative overflow-hidden transition-colors duration-500">
      {/* Animated Mesh Gradient Background */}
      <div className="fixed inset-0 -z-20 overflow-hidden pointer-events-none">
        <div className="absolute top-[-10%] left-[-10%] w-[70vw] h-[70vw] bg-blue-400/10 dark:bg-blue-600/10 rounded-full blur-[120px] animate-blob"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[60vw] h-[60vw] bg-violet-400/10 dark:bg-violet-600/10 rounded-full blur-[120px] animate-blob animation-delay-2000"></div>
        <div className="absolute top-[20%] right-[10%] w-[40vw] h-[40vw] bg-indigo-400/5 dark:bg-indigo-600/5 rounded-full blur-[100px] animate-blob animation-delay-4000"></div>
      </div>
